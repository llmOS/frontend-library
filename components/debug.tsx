...
import {IconTriangleClosed, IconTriangleOpen} from "./ui/icons";
...
const DropDown = ({title, children}: DropdownProps) => {
  ...
  return <div>
    <div
      className="oc-cursor-pointer oc-border-y-2 oc-flex oc-flex-row oc-justify-between"
...
const DebugText = ({metric}: { metric: DebugMetric }) => {
  ...
  return <div
    style={{fontSize: "14px"}}
  >
    {metric.tokenCount && <div className="oc-font-bold">Token count: {metric.tokenCount}</div>}
    {isJson(metric.value) ?
      <div>
